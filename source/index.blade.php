    ...
    <div class="bg-swiss-coffee-500 flex flex-col items-center overflow-hidden md:min-h-[calc(75vh)]">
        <section class="container flex flex-grow flex-wrap items-end justify-center pt-4 pl-4 pr-4 xl:flex-nowrap xl:px-8">
            ...
            <div class="mb-16 w-full md:w-2/5 xl:mb-48">
                ...
                <p>
                    Check out my
                    <a href="https://www.linkedin.com/in/martdingley/" target="_blank" class="relative no-underline">
                        <svg viewBox="0 0 924 226" class="relative -top-[1px] inline w-20 align-middle" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" >
