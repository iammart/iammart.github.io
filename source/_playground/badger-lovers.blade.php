...
@section('content')
    <div class="bg-black text-white">
        <div class="container mx-auto grid md:grid-cols-2">
            <div class="flex items-start md:pt-16 ">
                <img src="/assets/img/playground/badgers/badgerlovers-7.png" alt="{{ $page->title }}" loading="lazy" class="w-full md:rounded">
            </div>
                    ...
                    @foreach (range(1, 6) as $idx)
                        <li class="bg-black">
                            <div class="border-swiss-coffee-600 border  p-2  -ml-px -mt-px">
                                <img src="/assets/img/playground/badgers/badgerlovers-0{{ $idx }}.png" alt="{{ $page->title }} Alternative {{ $idx }}" loading="lazy" class="rounded bg-white">
                            </div>
                        </li>
                    @endforeach
                </ul>
